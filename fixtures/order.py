...
from clients.order_client.order_schema import CreateOrderSchema, OrderResponseSchema
from fixtures.cart import FunctionCart
from fixtures.users import FunctionUser


@pytest.fixture(scope="function")
def function_order(http: HttpClients, function_user: FunctionUser, function_cart: FunctionCart) -> OrderResponseSchema:
